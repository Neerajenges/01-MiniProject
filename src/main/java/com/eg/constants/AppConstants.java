...
public class AppConstants {
	//we are declaring variable with upper case because it is constant & use underScore to separate words
	...
	public static final String PLAN_CHANGE_STATUS_SUCC="planChangeStatusSucc";
	public static final String PLAN_CHANGE_STATUS_FAIL="planChangeStatusFail";
